	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">Recipe Book</span>
			</a>
		</div>
      ...
      <h2 className="uppercase dark:text-gray-900  mb-4">Contact Us</h2>
      <p className="mb-2">📍 123 Main Street, Dhaka, Bangladesh</p>
      <p className="mb-2">📞 +880 1712-345678</p>
      <p className="mb-2">✉️ info@yourwebsite.com</p>
